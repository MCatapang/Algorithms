/*
The people who buy ads on our network don't have 
enough data about how ads are working for
their business. They've asked us to find out which ads 
produce the most purchases on their website.

Our client provided us with a list of user IDs of 
customers who bought something on a landing page
...
function networkAds(purchaserIDs, adClicks, userIDs) {
    let clicksPerAd = {};
    let purchasersAdClick = 0;

    let parsedAdClicks = [];
    adClicks.forEach(click => {
        parsedAdClicks.push(click.split(","));
    });

    return parsedAdClicks;
}

console.log(networkAds(a, b, c));